Shader "SpaceTime/Scene/TerrainMesh/SplatmapUnwrap"
{
    Properties
    {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma vertex vert_Unwrap
            #pragma fragment frag_Unwrap
        ...
        // #define RENDER_LEVEL_1 1
            ...
            PackedVaryings PackVaryings (Varyings input)
            {
                ...
                output.positionCS = float4(float2(input.uv2.x * 2 - 1, 1 - input.uv2.y * 2), 1.0f, 1.0f);
            ...
            // --------------------------------------------------
            // Graph
            #pragma shader_feature_local_fragment _ _T2M_LAYER_COUNT_4 _T2M_LAYER_COUNT_8 //_T2M_LAYER_COUNT_9 //_T2M_LAYER_COUNT_10 _T2M_LAYER_COUNT_11 _T2M_LAYER_COUNT_12 _T2M_LAYER_COUNT_13 _T2M_LAYER_COUNT_14 _T2M_LAYER_COUNT_15 _T2M_LAYER_COUNT_16
            ...
            Varyings BuildVaryings_Unwrap(Attributes input)
            {
                ...
                output.uv2 = float2(input.uv2.x, abs(input.uv2.y));
                return output;
            }

            PackedVaryings vert_Unwrap(Attributes input)
            {
                Varyings output = (Varyings)0;
                output = BuildVaryings_Unwrap(input);
                PackedVaryings packedOutput = (PackedVaryings)0;
                packedOutput = PackVaryings(output);
                return packedOutput;
            }

            half4 UniversalFragmentPBR_Terrain_Unwrap(Varyings unpacked, SurfaceDescriptionInputs surfaceDescriptionInputs)
            {
                SurfaceDescription surfaceDescription = SurfaceDescriptionFunction(unpacked, surfaceDescriptionInputs);

                return half4(surfaceDescription.BaseColor, 0);
            ...
            half4 frag_Unwrap(PackedVaryings packedInput) : SV_TARGET
            {
                ...
                half4 color = UniversalFragmentPBR_Terrain_Unwrap(unpacked, surfaceDescriptionInputs); 
